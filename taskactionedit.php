                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mx-auto px-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <input type="text" class="form-control"
                                            id="actionname_<?php echo ($actionItem->UID); ?>" name="actionname"
                                            placeholder="Action Name" aria-describedby="NameHelp"
                                            value="<?php  echo $actionItem->Name; ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm">
                                        <select name="triggerType" class="form-control"
                                            ...
                                            <option class="form-control" value="<?php echo $Key; ?>"
                                                <?php echo $actionItem->Trigger->TriggerType == $Key? 'selected':'' ?>>
                                    ...
                                    <div id="Time_<?php echo ($actionItem->UID); ?>" class="col-sm">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="hour" placeholder="Hours"
                                                id="hour_<?php echo ($actionItem->UID); ?>"
                                                value="<?php echo $actionItem->Trigger->Hour ?>">
                                            ...
                                            <input type="text" class="form-control" name="minute" placeholder="Minutes"
                                                id="minute_<?php echo ($actionItem->UID); ?>"
                                                value="<?php echo $actionItem->Trigger->Minute ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group ">
                                            <div class="input-group-prepend">
                                                <select name="offsetdirection" class="form-control input-group-text">
                                                    <option value="+"
                                                        <?php echo $actionItem->Trigger->OffsetDirection=='+' ? 'selected' : '' ?>>
                                                        +</option>
                                                    <option value="-"
                                                        <?php echo $actionItem->Trigger->OffsetDirection=='-' ? 'selected' : '' ?>>
                                                        -</option>
                                            ...
                                            <input type="text" class="form-control" name="offsethour"
                                                id="offsethour_<?php echo ($actionItem->UID); ?>" placeholder="Hours"
                                                value="<?php echo $actionItem->Trigger->OffsetHour ?>">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1">H</span>
                                            </div>
                                            <input type="text" class="form-control" name="offsetminute"
                                                id="offsetminute_<?php echo ($actionItem->UID); ?>"
                                                placeholder="Minutes"
                                                value="<?php echo $actionItem->Trigger->OffsetMinute ?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm">
                                        <select name="Action" class="form-control input-group-text"
                                            id="actionType_<?php echo ($actionItem->UID); ?>"
                                            onchange="TASKFORM.ToogleDevices('<?php echo ($actionItem->UID); ?>');">
                                            <option class="form-control">-</option>'

                                            <?php foreach( Action::GetActionTypes() as $Key => $Value) : ?>
                                            <option class="form-control" value="<?php echo $Key; ?>"
                                                <?php echo $actionItem->ActionType == $Key? 'selected':'' ?>>
                                                <?php echo $Value; ?></option>
                                            <?php endforeach; ?>
                                    ...
                                    <div class="col-sm">
                                        <input type="text" id="setdevicevalue_<?php echo ($actionItem->UID); ?>"
                                            class="form-control" name="setdevicevalue" placeholder="Value (%)"
                                            value="<?php echo $actionItem->Value?>">
                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <span class="form-check form-check-inline" style="width:250px;">
                                            <input type="checkbox" name="lightdevices[]"
                                                ...
                                                <?php echo $actionItem->ContainsDevice($ohItem->Name ) ? ' checked ' : '' ?> />
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="cmdActionExistingSave"
                                onclick="return TASKFORM.ValidateTrigger('<?php echo ($actionItem->UID); ?>')">Save
                                changes</button>
                        </div>
                    </div>
                </div>
